...
extension UIColor {
    ...
    static var darkPink = UIColor.rgb(red: 255, green: 93, blue: 131)
    static var lightPink = UIColor.rgb(red: 255, green: 135, blue: 163)
    
}

extension UIFont {
    
    static func Opun(size: CGFloat) -> UIFont {
        return UIFont(name: "Opun-Regular", size: size) ?? UIFont.boldSystemFont(ofSize: size)
    }
